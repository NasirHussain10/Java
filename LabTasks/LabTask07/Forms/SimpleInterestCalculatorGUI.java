...
public class SimpleInterestCalculatorGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SimpleInterestCalculatorGUI frame = new SimpleInterestCalculatorGUI();
	 ...
	 * Create the frame.
	 */
	public SimpleInterestCalculatorGUI() {
